...
# line to override these default values.
  ...
  return {
        ...
        small_lsf_options   => '-qproduction-rh74 -R"select[mem>250]  rusage[mem=250]"  -M250',
        default_lsf_options => '-qproduction-rh74 -R"select[mem>1000] rusage[mem=1000]" -M1000',
        highmem_lsf_options => '-qproduction-rh74 -R"select[mem>2500] rusage[mem=2500]" -M2500',
        hugemem_lsf_options => '-qproduction-rh74 -R"select[mem>6000] rusage[mem=6000]" -M6000',
