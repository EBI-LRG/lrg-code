...
<!--   select="substring-before($coord_system,'.')" />-->
  ...
  <p>
    <span class="line_header">Region covered:</span><span class="blue"><xsl:value-of select="$region_name"/></span>:<xsl:value-of select="$region_start"/>-<xsl:value-of select="$region_end"/>
